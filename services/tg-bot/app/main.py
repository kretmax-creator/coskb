...
from app.handlers import start_handler, help_handler, search_handler, read_handler, similar_handler, stats_handler
...
def main():
    ...
    app.add_handler(CommandHandler("stats", stats_handler, filters=chat_filter))
