...
- [ ] Добавить PostgreSQL FTS поиск в search-api (ts_rank по tsvector)
- [ ] Взвешенное объединение: `score = α * fts_score + β * vector_score`
- [ ] Подбор весов α/β на реальных запросах
- [ ] Обновить `GET /search` — гибридный режим по умолчанию
- [ ] Обновить диаграмму `docs/diagrams/search-sequence.md`
